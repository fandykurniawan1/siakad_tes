...
@section('content')
    ...
    <div class="panel">
        <div class="panel-body" id="add-form" {!! count($errors) == 0 ? "style='display: none;'" : '' !!}>
            ...
            <form class="form-horizontal" id="form" action="{{ route('backend.management.user.store') }}" method="POST" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class='row'>
                ...
                <div class='row'>
                    <div class='form-group col-md-12'>
                        ...
                        <br /><input type='checkbox' name='active' data-plugin='switchery' data-color="#ffde17" {{ old('active', 1) ? 'checked' : '' }}>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#datatable').dataTable({
                ...
                ajax: {
                    method: 'POST',
                    url : '{{ route('backend.management.user.data') }}',
                    headers: {
