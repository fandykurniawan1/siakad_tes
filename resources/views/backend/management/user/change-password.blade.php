...
@section('head')
    <title>Change Password | Loyalto</title>
@endsection
...
@endsection
@push('breadcrumb')
    <li class="breadcrumb-item active"><a href="{{ route('backend.management.user.index') }}">User</a></li>
...
@section('content')
    <div class="panel">
        <div class="panel-body">
            ...
            <form class="form-horizontal" method="POST" action="{{ isset($id) ? route('backend.management.user.other.update-password', $id) : route('backend.management.user.update-password') }}">
                {!! csrf_field() !!}
                {!! method_field('PUT') !!}
                <div class="row">
